define([], function () {
    ...
    return {
        ...
        dashboardUrl:
            "https://geo.azmag.gov/arcgis/rest/services/Hosted/DashboardData/FeatureServer/0",
        ...
        covidZipLayerURL:
            "https://geo.azmag.gov/arcgis/rest/services/Hosted/COVID19_By_Zip_Code/FeatureServer/0",
        ...
        layers: [
            ...
            {
                type: "feature",
                title: "Drive-Thru COVID-19 Testing",
                id: "DriveThru",
                definition:
                    "Walgreens locations with Drive-Thru COVID-19 testing.",
                visible: false,
                scalable: true,
                showToc: true,
                index: 6,
                uvr: [
                    {
                        ...
                        symbol: {
                            type: "picture-marker",
                            url: "icons/Drive_through_Testing.svg",
                        },
                    },
                ],
            },
